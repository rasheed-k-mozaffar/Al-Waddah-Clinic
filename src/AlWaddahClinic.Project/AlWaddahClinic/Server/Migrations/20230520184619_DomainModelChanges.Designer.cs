...
namespace AlWaddahClinic.Server.Migrations
{
    ...
    [Migration("20230520184619_DomainModelChanges")]
    partial class DomainModelChanges
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AlWaddahClinic.Server.Models.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "f950430b-b0ab-4247-a551-0079c7ae1de1",
                            Email = "admin@doctor.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "ADMIN@DOCTOR.COM",
                            NormalizedUserName = "ADMIN@DOCTOR.COM",
                            PasswordHash = "AQAAAAIAAYagAAAAEH7l4R6hbmzEKd3C0kWWntHfOVF/3V8Pd8JdHMxTvjnZUNgMklucKsSJvr1Eq8sxbA==",
