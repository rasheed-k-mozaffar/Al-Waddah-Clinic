...
{
    /// <inheritdoc />
    public partial class ConfiguredUsersAndClinicsRelationship : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GraduatedIn = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DoctorProfilePicUrl = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
